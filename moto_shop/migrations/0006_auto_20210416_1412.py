# Generated by Django 3.1.7 on 2021-04-16 11:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('moto_shop', '0005_auto_20210416_1024'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='moto_shop.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='moto_shop.Order', verbose_name='Заказы покупателя'),
        ),
    ]
